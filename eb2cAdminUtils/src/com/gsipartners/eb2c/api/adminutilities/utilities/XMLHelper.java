...
public class XMLHelper {
     ...
     */
    public static String getNodeAsXML(Node pInputNode) throws Eb2cAPIAdminUtilitiesException {
        ...
        try {
            ...
            logger.error(e);
            throw new Eb2cAPIAdminUtilitiesGeneralException("ParserConfigurationException when attempting to create XML Output. " + e);

        } catch (TransformerFactoryConfigurationError e1) {
            logger.info("TransformerFactoryConfigurationError Exception caught when trying to create XML Output.", e1);
            logger.error(e1);
            throw new Eb2cAPIAdminUtilitiesGeneralException("TransformerFactoryConfigurationError when attempting to create XML Output. " + e1);
