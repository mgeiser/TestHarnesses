...
public class ConsumerDelete implements UtilitiesCommand {

	/**
	 * Logger.
	 */
	private static Logger logger = Logger.getLogger(ConsumerDelete.class);
	...
	public void runCommand(Eb2cAPIAdminUtilitiesPropertiesDO pPropertiesDO) throws Eb2cAPIAdminUtilitiesException {
        ...
        //Call the API to delete the consumerId 
		executionContext.ServiceURI = new StringBuffer();

		//create the service call URI
		executionContext.ServiceURI.append(UtilityCommandConstants.COMMAND_CONSUMER_DELETE_URI)
		...
		executionContext = commonServiceCalls.executeServiceCall(executionContext, "Delete the Consumer id on target Key Manager");
